  ...
  data: [
    {
      name: "vue-next",
      itemSrc:
        "https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c588b8ab65a74d59aa379801136df4e0~tplv-k3u1fbpfcp-watermark.image",
      targetLink: "https://github.com/vuejs/docs-next-zh-cn",
    },
    {
      name: "vitejs",
      itemSrc:
        "https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/a7351d2dcd7846158604ac8bd57222b5~tplv-k3u1fbpfcp-watermark.image",
      targetLink: "https://github.com/vitejs",
    },
    {
      name: "element-plus",
      itemSrc:
        "https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/48a7fd198df44cca9c0dc10a8047bbef~tplv-k3u1fbpfcp-watermark.image",
      targetLink: "https://github.com/element-plus/element-plus",
    },
    {
      name: "tslang",
      itemSrc:
        "https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/610fc57450884ceaae9578689663fe2f~tplv-k3u1fbpfcp-watermark.image",
...
Mock.mock("/api/auth/user/login", "post", (option: any) => {
  const { email, password } = JSON.parse(option.body);
  if (email == "wwcattle.com" && password == "123456") {
    return {
      status: 0,
      data: {
        accessToken:
...
// 登录成功，查询用户信息，包括角色
Mock.mock("/api/auth/user/userInfo", "post", (option: any) => {
...
Mock.mock("/api/setting/basicInfo", "post", (option: any) => {
